...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String... args) {
        ...
        final SocialNetworkUser<User> dwashington = new SocialNetworkUserImpl<User>("Denzel", "Washington", "dwashington", 59); //TODO
        final SocialNetworkUser<User> mgladwell = new SocialNetworkUserImpl<User>("Malcom", "Gladwell", "mgladwell", 51); //TODO
        final SocialNetworkUser<User> ntaleb = new SocialNetworkUserImpl<User>("Nicholas", "Taleb", "ntaleb", 54); //TODO
